...
class Warrior(Hero):
    def __init__(self, name: str) -> None:
        super().__init__(name=name, health=100, magic=10, weapon=obsidian_sword)
        self.weapon = fists
        self.health_bar = HealthBar(self, color="blue")
...
class Wizard(Character):
    def __init__(self, name: str, health: int = 75, magic: int = 30, weapon: Weapon = iron_sword) -> None:
...
class Thief(Hero):
    def __init__(self, name: str) -> None:
        super().__init__(name=name, health=100, magic=10, weapon=short_bow)
        self.weapon = fists
        self.health_bar = HealthBar(self, color="blue")
...
class Cleric(Hero):
    def __init__(self, name: str) -> None:
        super().__init__(name=name, health=100, magic=30, weapon=fists)
        self.weapon = fists
        self.health_bar = HealthBar(self, color="blue")
